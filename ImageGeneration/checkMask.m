function [] = checkMask()
%   checkMask checks how good masks fit to given images. It shows the mask
%   generated for the images of given participant. Participant images needs
%   to be in the raw_images folder. 
%   
